 ...
 */
public class Farmer5 implements ICrosser {
private int xf;
private int yf;
    @Override
    ...
    public BufferedImage[] getImages() {
     ...
     try {
         img[0] = ImageIO.read(new File("boy.png"));
         img[1]= ImageIO.read(new File("boyflip.png"));
     } catch (IOException ex) {
         Logger.getLogger(Plant.class.getName()).log(Level.SEVERE, null, ex);
     }
        /*ImageIcon b[] = new ImageIcon[2];
        b[0] = new ImageIcon("boy.png");
        b[1] = new ImageIcon("boyflip.png");*/
        return img; 
    }
