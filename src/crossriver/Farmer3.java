...
private int yf;
    ...
    public BufferedImage[] getImages() {
     ...
     try {
         img[0] = ImageIO.read(new File("farmerwomen.png"));
         img[1]= ImageIO.read(new File("farmerwomenflip.png"));
     } catch (IOException ex) {
         Logger.getLogger(Plant.class.getName()).log(Level.SEVERE, null, ex);
     }
       /*ImageIcon b[] = new ImageIcon[2];
        b[0] = new ImageIcon("farmerwomen.png");
        b[1] = new ImageIcon("farmerwomenflip.png");*/
        return img; 
    }
